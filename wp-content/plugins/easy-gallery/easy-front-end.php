...
function show_easy_gallery($atts,$content=null)
{
	...
	?>
	<!-- <link href="css/easy-front-end.css" rel="stylesheet" type="text/css" /> -->
<!-- 
	...
	?>
             <li class="col-xs-6 col-sm-4 col-md-3" data-responsive="" data-src="<?php echo $obj->image_path; ?>" data-sub-html="">
                    <a href="">
                        <img class="img-responsive" src="<?php echo $obj->thumb_path; ?>">
                    </a>
                </li>
     <!-- </div> -->
    <?php 
