...
<div class="wrap">
  <div  class="easy_album_ico"></div>
    <h2 style="padding-top:20px;">EASY GALLERY - Add photos</h2>
    <div class="tablenav">    
    <h2>
...
<a class=" add-new-h2" href="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=easy-gallery-home&ac=add">Add Photo</a>	 
  ...
  <div style="border-bottom:1px solid #B7B7B7; padding-bottom:10px;" >
  ...
  <div class="np_upload_form" id="easy_upload_window">
  <h4>File Upload <span onclick="hide_easy_upload()">close</span></h4>
    ...
    <span style="margin-left:5px;margin-right:5px; display:none;float:left; " id="show_select_all"><input type="checkbox" name="select_all" value="0" id="select_all"  style="margin-right:3px;" />Select All</span>
