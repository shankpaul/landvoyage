...
function install_easy_gallery()
{
     ...
     */
        ...
        add_option("EasyGallery-album-cover-height",120);
        add_option("EasyGallery-album-cover-width",242);
...
function add_javascript_easy() {
    ...
    // loads your stylesheet
    wp_enqueue_script( 'EasyGalleryThirdPartyScript' ); 
    ...
    // loads your stylesheet
    wp_enqueue_script( 'EasyGalleryThirdPartyScriptFancy' ); 
	/*
	 * Easy gallery script
	 */
    ...
    // loads your stylesheet
    wp_enqueue_script( 'EasyGalleryScript' ); 
